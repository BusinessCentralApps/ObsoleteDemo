...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-incremental-build/Actions/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/mazhelez/AL-Go/fix-incremental-build/Actions/AL-Go-Helper.ps1'
